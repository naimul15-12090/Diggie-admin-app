...
public class UpdateTeacherActivity extends AppCompatActivity {
    ...
    private EditText updateTeacherName, updateTeacherEmail, updateTeacherInitial, updateTeacherPhone, updateTeacherId;
    private Button updateTeacherBtn, deleteTeacherBtn;
    private  final int REQ =1;
    private String name, email, image, initial, phone,teacherId, downloadUrl = "", uniqueKey, category;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateTeacherInitial = findViewById(R.id.updateTeacherInitial);
        ...
        updateTeacherInitial.setText(initial);
        updateTeacherPhone.setText(phone);
        updateTeacherId.setText(teacherId);
        ...
        updateTeacherBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                initial = updateTeacherInitial.getText().toString();
                phone = updateTeacherPhone.getText().toString();
                teacherId = updateTeacherId.getText().toString();
        ...
        deleteTeacherBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                builder.setMessage("Do you want to Delete this Teacher ?");
    ...
    private void checkValidation() {
        if(name.isEmpty()){
            ...
            updateTeacherInitial.setError("Empty");
            updateTeacherInitial.requestFocus();
        }else if (phone.isEmpty()){
            updateTeacherPhone.setError("Empty");
            updateTeacherPhone.requestFocus();
        }else if (teacherId.isEmpty()){
            updateTeacherId.setError("Empty");
            updateTeacherId.requestFocus();
        }else if (bitmap == null){
            updateData(image);
        }else{
            uploadImage();
    ...
    private void updateData(String s) {
        ...
        hp.put("name",name);
        hp.put("email",email);
        hp.put("initial",initial);
        hp.put("phone",phone);
        hp.put("teacherId",teacherId);
        hp.put("image",s);
